...
public class ExtentReportManager implements ITestListener
{
	...
	{	
		...
		test.createNode(result.getName()); // create new entry in the report
...
//					email.setAuthenticator(new DefaultAuthenticator("mahesholtraining@gmail.com", "Mypassword"));
//					email.setSSLOnConnect(true);
//					email.setFrom("mahesholtraining@gmail.com");   //Sender
//					email.setSubject("Test Results");
//					email.setMsg("Please find Attached Report....");
//					email.addTo("query2mahesh@gmail.com");   //Receiver 
